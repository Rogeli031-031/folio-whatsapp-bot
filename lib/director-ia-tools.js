...
const TOOLS = [
  ...
  },
  {
    ...
    limitations: "Kanban/folios no integrados en Director IA.",
  ...
  },
  {
    ...
    executor: null,
    sourceFiles: ["server.js"],
    limitations: "Timeline de folio no integrado.",
    requiredInputs: ["planta_id", "folio_id"],
  },
  {
    ...
    executor: null,
    sourceFiles: ["server.js"],
    limitations: "Medios/PDF no integrados.",
    requiredInputs: ["planta_id", "folio_id"],
  },
  {
  ...
  },
  {
    ...
    executor: null,
    sourceFiles: ["server.js"],
    limitations: "Presupuestos no integrados en Director IA.",
    requiredInputs: ["planta_id"],
  },
  {
    ...
    executor: null,
    sourceFiles: ["server.js"],
    limitations: "Módulo Proyectos no integrado.",
    requiredInputs: ["planta_id"],
  },
  {
    id: "get_expense_analysis",
    label: "Análisis de gastos / Taller AT",
    domain: "gastos",
    status: TOOL_STATUS.declared_not_integrated,
    accessMode: TOOL_ACCESS_MODE.not_integrated,
    readOnly: true,
    executor: null,
    sourceFiles: ["lib/categoria-rango-excel.js", "lib/taller-at-excel.js"],
    limitations: "Excel GASTOS / Taller AT no integrados.",
    requiredInputs: ["planta_id", "question"],
  },
  {
    ...
    readOnly: true,
    executor: null,
    sourceFiles: ["lib/categoria-rango-excel.js"],
    limitations: "Excel INVERSIONES no integrado.",
    requiredInputs: ["planta_id", "question"],
  },
  {
    id: "get_delta_sales",
    ...
    executor: null,
    sourceFiles: ["server.js"],
    limitations: "Endpoints delta-venta no cableados a Director IA.",
    requiredInputs: ["planta_id", "question"],
  },
  {
    ...
    executor: null,
    sourceFiles: ["server.js"],
    limitations: "Endpoints delta-descuento no cableados a Director IA.",
    requiredInputs: ["planta_id", "question"],
  },
  {
    id: "get_delta_income",
    ...
    readOnly: true,
    executor: null,
    sourceFiles: ["lib/delta-ingreso-forecast.js", "server.js"],
    limitations: "Endpoints delta-ingreso no cableados a Director IA.",
    requiredInputs: ["planta_id", "question"],
  },
  {
    ...
    readOnly: true,
    executor: null,
    sourceFiles: ["lib/folio-duplicados.js"],
    limitations: "Análisis de duplicados no integrado en Director IA.",
    requiredInputs: ["planta_id"],
  },
  {
...
const DOMAIN_TO_TOOLS = Object.freeze({
  ...
  taller_at: ["get_expense_analysis"],
