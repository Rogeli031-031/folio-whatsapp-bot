...
const TOOLS = [
  ...
  {
    id: "get_action_register_revision_notes",
    label: "Notas de revisión Action Register",
    domain: "revision_notes",
    ...
    sourceFiles: ["lib/director-ia-m12-revision-notes.js"],
    limitations:
      "1 revisión; máx. 8 notas; 500 caracteres; truncation explícito. No ítem, no Plaud, no M2, no binarios.",
  ...
  {
    id: "get_historical_margin",
    label: "Margen histórico $/kg",
    domain: "historical_margin",
    status: TOOL_STATUS.available_on_demand,
    accessMode: TOOL_ACCESS_MODE.on_demand,
    readOnly: true,
    executor: "loadHistoricalMarginForChat",
    sourceFiles: ["lib/director-ia-historical-margin.js"],
    limitations: "FINAL cerrado; forecast mes abierto; futuro fail-closed; matcher único; sin OpenAI.",
    requiredInputs: ["planta_id", "question"],
  },
  {
    id: "get_historical_new_clients",
    label: "Clientes nuevos históricos",
    domain: "historical_new_clients",
    status: TOOL_STATUS.available_on_demand,
    accessMode: TOOL_ACCESS_MODE.on_demand,
    readOnly: true,
    executor: "loadHistoricalNewClientsForChat",
    sourceFiles: ["lib/director-ia-new-clients.js"],
    limitations: "Mes calendario cerrado; kg/descuento reales; lista completa; sin forecast.",
    requiredInputs: ["planta_id", "question"],
  },
  {
    id: "get_commercial_dossier",
    label: "Expediente comercial",
    domain: "commercial_dossier",
    status: TOOL_STATUS.available_on_demand,
    accessMode: TOOL_ACCESS_MODE.on_demand,
    readOnly: true,
    executor: "loadCommercialDossierForChat",
    sourceFiles: ["lib/director-ia-m11-commercial-dossier.js"],
    limitations:
      "1 cliente; 8 comentarios / 500 chars; 8 acciones; 8 eventos. SELECT-only. Sin causalidad. Sin bitácora.",
    requiredInputs: ["planta_id", "question"],
  },
  {
    id: "get_folio_status",
  ...
  {
    id: "get_igf_reviewable_supports",
    label: "Apoyos reviewable / contrafactual IGF",
    domain: "folios",
    status: TOOL_STATUS.available_on_demand,
    accessMode: TOOL_ACCESS_MODE.on_demand,
    readOnly: true,
    executor: "loadIgfReviewableSupportsForChat",
    sourceFiles: ["lib/director-ia-igf-reviewable-supports.js"],
    limitations:
      "Read-only. REVIEWABLE = reglas reales de cancelación. Overlay IGF en memoria. No writes. No cheques. No ahorro/cash.",
    requiredInputs: ["planta_id", "question"],
  },
  {
    id: "get_folio_search",
    label: "Búsqueda de folios / apoyos",
    domain: "folio_search",
    status: TOOL_STATUS.available_on_demand,
    accessMode: TOOL_ACCESS_MODE.on_demand,
    readOnly: true,
    executor: "loadFolioSearchForChat",
    sourceFiles: ["lib/director-ia-folio-search.js", "lib/director-ia-igf-reviewable-supports.js"],
    limitations:
      "Read-only. Scope ALL_PUBLIC_FOLIOS o SUPPORT_FAMILIES. Reutiliza queryReviewableSupportFolios sin filtro IGF. mes_cargo obligatorio. No writes.",
    requiredInputs: ["planta_id", "question"],
  },
  {
    id: "get_client_ranking",
    label: "Ranking comercial de clientes",
    domain: "client_ranking",
    status: TOOL_STATUS.available_on_demand,
    accessMode: TOOL_ACCESS_MODE.on_demand,
    readOnly: true,
    executor: "loadClientRankingForChat",
    sourceFiles: ["lib/director-ia-client-ranking.js"],
    limitations:
      "Read-only. VENTA_TON o DESCUENTO_POR_KG sobre ARR. No inventa clientes ni descuentos. Requiere periodo defendible.",
    requiredInputs: ["planta_id", "question"],
  },
  {
    id: "get_client_movement",
    label: "Movimiento comercial de clientes",
    domain: "client_movement",
    status: TOOL_STATUS.available_on_demand,
    accessMode: TOOL_ACCESS_MODE.on_demand,
    readOnly: true,
    executor: "loadClientMovementForChat",
    sourceFiles: ["lib/director-ia-client-movement.js"],
    limitations: "Read-only. Valores crudos. No forecast para DEJO_DE_COMPRAR.",
    requiredInputs: ["planta_id", "question"],
  },
  {
    id: "get_client_evidence",
    label: "Evidencia y acciones de cliente",
    domain: "client_evidence",
    status: TOOL_STATUS.available_on_demand,
    accessMode: TOOL_ACCESS_MODE.on_demand,
    readOnly: true,
    executor: "loadClientEvidenceForChat",
    sourceFiles: ["lib/director-ia-client-evidence.js"],
    limitations: "Read-only. Preserva source_type. No mezcla DICF y Action Register.",
    requiredInputs: ["planta_id", "question"],
  },
  {
    id: "get_procurement_by_concept",
    label: "Compras por concepto",
    domain: "folio_search",
    status: TOOL_STATUS.available_on_demand,
    accessMode: TOOL_ACCESS_MODE.on_demand,
    readOnly: true,
    executor: "loadProcurementForChat",
    sourceFiles: ["lib/director-ia-procurement-by-concept.js"],
    limitations: "Read-only. Gasto relacionado, no exclusivo. beneficiario != proveedor. Unit cost fail-closed.",
    requiredInputs: ["planta_id", "question"],
  },
  {
  ...
  {
    id: "get_taller_at",
    label: "Consulta de Taller por AT",
    domain: "taller_at",
    status: TOOL_STATUS.available_on_demand,
    accessMode: TOOL_ACCESS_MODE.on_demand,
    readOnly: true,
    executor: "loadTallerAtForChat",
    sourceFiles: ["lib/director-ia-m5-taller-at.js", "lib/taller-at-excel.js", "lib/unidad-taller.js"],
    limitations:
      "Query JSON TALLER por public.folios.unidad; YYYY-MM obligatorio; no Excel; no duplicados; no at_id.",
    requiredInputs: ["planta_id", "question"],
  },
  {
    ...
    limitations: "Excel Taller AT no integrado. Distinto de la query JSON get_taller_at.",
    requiredInputs: ["planta_id", "question"],
  },
  {
  ...
  {
    id: "get_daily_sales_deviation",
    label: "Desviación diaria de venta",
    domain: "arr",
    status: TOOL_STATUS.available_on_demand,
    accessMode: TOOL_ACCESS_MODE.on_demand,
    readOnly: true,
    executor: "loadDailySalesDeviationForChat",
    sourceFiles: ["lib/director-ia-daily-deviation.js"],
    limitations:
      "Venta kg diaria vs same-weekday 14d; no descuento/kg; no M9 mensual; contribución != causa.",
    requiredInputs: ["planta_id", "question"],
  },
  {
    id: "get_daily_discount_deviation",
    label: "Desviación diaria de descuento/kg",
    domain: "arr",
    status: TOOL_STATUS.available_on_demand,
    accessMode: TOOL_ACCESS_MODE.on_demand,
    readOnly: true,
    executor: "loadDailyDiscountDeviationForChat",
    sourceFiles: ["lib/director-ia-daily-discount.js"],
    limitations:
      "Descuento/kg diario SUM(monto)/SUM(kg) vs same-weekday 14d pooled; no canal; no M9; contribución != causa.",
    requiredInputs: ["planta_id", "question"],
  },
  {
    id: "get_daily_executive_brief",
    label: "Brief ejecutivo diario",
    domain: "arr",
    status: TOOL_STATUS.available_on_demand,
    accessMode: TOOL_ACCESS_MODE.on_demand,
    readOnly: true,
    executor: "loadDailyExecutiveBriefForChat",
    sourceFiles: ["lib/director-ia-daily-executive-brief.js"],
    limitations:
      "Compone venta diaria + descuento/kg de la misma planta/fecha; no ingreso diario; no causalidad; missing != 0.",
    requiredInputs: ["planta_id", "question"],
  },
  {
    id: "get_commercial_trend",
    label: "Tendencia comercial 30/90",
    domain: "arr",
    status: TOOL_STATUS.available_on_demand,
    accessMode: TOOL_ACCESS_MODE.on_demand,
    readOnly: true,
    executor: "loadCommercialTrendForChat",
    sourceFiles: ["lib/director-ia-commercial-trend.js", "lib/commercial-trend-engine.js"],
    limitations:
      "Serie + OLS + top-6 del motor compartido venta-serie; 30/90 trailing desde MAX(fecha); sin comments; mover != causa.",
    requiredInputs: ["planta_id", "question"],
  },
  {
    id: "get_client_profile",
    label: "Perfil longitudinal de cliente",
    domain: "arr",
    status: TOOL_STATUS.available_on_demand,
    accessMode: TOOL_ACCESS_MODE.on_demand,
    readOnly: true,
    executor: "loadClientProfileForChat",
    sourceFiles: ["lib/director-ia-client-profile.js"],
    limitations:
      "3 meses calendario CDMX; kg + SUM(monto)/SUM(kg); ingreso actual no soportado; comments/DICF por cliente_key; AR sin key.",
    requiredInputs: ["planta_id", "question"],
  },
  {
    id: "get_taller_mayor",
    label: "Taller Mayor por unidad",
    domain: "folios",
    status: TOOL_STATUS.available_on_demand,
    accessMode: TOOL_ACCESS_MODE.on_demand,
    readOnly: true,
    executor: "loadTallerMayorForChat",
    sourceFiles: ["lib/director-ia-taller-mayor.js", "lib/director-ia-m5-taller-at.js", "lib/unidad-taller.js"],
    limitations:
      "Read model Taller Mayor por token de public.folios.unidad; mes_cargo CDMX; no económico/placa; no unit master; no cancelación.",
    requiredInputs: ["planta_id", "question"],
  },
  {
    id: "get_pre_meeting_brief",
    label: "Preparación de junta / pre-cierre",
    domain: "arr",
    status: TOOL_STATUS.available_on_demand,
    accessMode: TOOL_ACCESS_MODE.on_demand,
    readOnly: true,
    executor: "loadPreMeetingBriefForChat",
    sourceFiles: ["lib/director-ia-pre-meeting.js", "lib/director-ia-executive-cycle-composer.js"],
    limitations:
      "Junta clásica: comercial + IGF abierto + acciones + reviewable + gaps. PRE_CLOSE: current/target/forecast planta a planta. No ACTUAL_FINANCIAL. No Taller Mayor, no MC, no Plaud. missing != 0.",
    requiredInputs: ["planta_id", "question"],
  },
  {
    id: "get_month_close_result",
    label: "Resultado mensual de cierre",
    domain: "arr",
    status: TOOL_STATUS.available_on_demand,
    accessMode: TOOL_ACCESS_MODE.on_demand,
    readOnly: true,
    executor: "loadMonthCloseResultForChat",
    sourceFiles: ["lib/director-ia-month-close-result.js"],
    limitations:
      "Una planta + un mes calendario. ACTUAL ARR vs TARGET igf_meta. IGF = FORECAST. financial.actual = FINAL stored si existe. Sin carry-forward.",
    requiredInputs: ["planta_id", "question"],
  },
  {
    id: "get_delta_sales",
...
const DOMAIN_TO_TOOLS = Object.freeze({
  ...
  historical_margin: ["get_historical_margin"],
  historical_new_clients: ["get_historical_new_clients"],
  commercial_dossier: ["get_commercial_dossier"],
  folios: ["get_folio_status", "get_igf_reviewable_supports"],
  folio_search: ["get_folio_search"],
  client_ranking: ["get_client_ranking"],
  client_movement: ["get_client_movement"],
  client_evidence: ["get_client_evidence"],
  ...
  taller_at: ["get_taller_at", "get_taller_at_analysis"],
