...
const TOOLS = [
  ...
  },
  {
    ...
    sourceFiles: ["lib/director-ia-pre-meeting.js"],
    limitations:
      "First slice B: comercial + IGF abierto + acciones + reviewable + gaps. No Taller Mayor, no MC, no Plaud, no mes cerrado. missing != 0.",
    requiredInputs: ["planta_id", "question"],
  },
  {
