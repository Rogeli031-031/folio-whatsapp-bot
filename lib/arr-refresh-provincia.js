...
async function syncProvinciaPlants(client) {
  ...
  // Siempre asegurar las primeras 6 de public.plantas (p. ej. Tehuacán) para que el dashboard muestre todas las columnas aunque env traiga solo un subconjunto
  await client.query(`
