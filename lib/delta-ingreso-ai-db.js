...
async function getPendientes(client, periodoA, periodoB) {
  const r = await client.query(
    `SELECT id, plant_code, cliente_norm, action_status, what, when_date, who, how_much_impact_mxn, last_update_text, last_update_at
     FROM public.delta_ingreso_ai_actions
...
/** Agrupa acciones por why_tag con conteo y suma how_much_impact_mxn. */
async function getCausaByPlant(client, periodoA, periodoB, plantCode) {
