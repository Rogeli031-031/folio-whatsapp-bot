...
async function getOpenActionsByPlant(client, plantCode, periodoA, periodoB) {
  const r = await client.query(
    `SELECT id, plant_code, cliente_norm, periodo_a, periodo_b, negative_type, what, why_tag, when_date, who, action_status, last_update_text, last_update_at, updated_at
