...
function resolveDirectorIaChatRouting(question, chatContext) {
  ...
  const wantMonthlyIntegrated = shouldUseMonthlyIntegratedChat(q, chatContext);
  const wantDicf =
    !wantCommercialState && !wantMonthlyIntegrated && shouldUseDicfFocusedChat(q, chatContext);
