    ...
    evidenceItem({
      ...
      summary:
        igfUtilOper == null
          ...
          : `Utilidad operativa ${igfUtilOper} (FORECAST_PROJECTION mini IGF Forecast utilOperImporte; corte ${cutoffDate || "n/d"}; no es stored ni ACTUAL_FINANCIAL ni TARGET).`,
    })
  );
  items.push(
    evidenceItem({
      ...
      summary:
        igfResultado == null
          ...
          : `Resultado final ${igfResultado} (FORECAST_PROJECTION mini IGF Forecast resultadoFinalImporte; corte ${cutoffDate || "n/d"}; no es stored ni ACTUAL_FINANCIAL ni TARGET).`,
    })
  );
