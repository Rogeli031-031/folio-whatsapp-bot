...
function extractClientMovementRankingSpec(question, prior, opts = {}) {
  ...
  return {
    ...
    pending_family:
      ...
      (disc.want_count ? "NEW_CLIENTS" : disc.want_discount ? "NEW_CLIENT_DISCOUNT" : disc.want_aggregate && movement === "DEJARON_DE_COMPRAR" ? "LOST_VOLUME_TOTAL" : null),
...
function priorMovementFromState(state) {
  ...
  return {
    ...
    pending_operation: (gap && gap.pending_operation) || (hit && hit.pending_operation) || null,
    ...
    payload && payload.clarification && spec && !hasPeriod(spec)
      ? {
          ...
          frame: {
            ...
            pending_family: spec.pending_family,
            pending_intent: "client_movement",
          },
