...
function resolveConversationTurn(opts) {
  ...
  const standalone = isStandaloneDetected(detected) && !dailyFollowUp && !trendFollowUp && !profileHandoffFromTrend && !profileFollowUp;
  ...
  if (restorePrevious || stayOnCurrent) {
    ...
    validInheritContext &&
    !standalone &&
    (isolatedUnknown || dailyFollowUp || trendFollowUp || profileFollowUp || profileHandoffFromTrend)
  ) {
    inherit = true;
  }
