...
async function computeDicf(client, plantCode, plantaNombre, getMargenKg) {
  ...
  for (const cliente of allClientes) {
    ...
    const es_aumentaron = !es_dejaron && !es_nuevo && ingreso_esperado > 0 && ingreso_forecast > 0 && delta_ingreso >= 0;
    const es_disminuyeron = !es_dejaron && !es_nuevo && ingreso_esperado > 0 && ingreso_forecast >= 0 && delta_ingreso < 0;
