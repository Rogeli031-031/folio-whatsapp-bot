...
function projectKgToMonthEnd(series, startDateStr, endDateStr, monthEndStr) {
  ...
  // Para que el forecast sea comparable cuando faltan 14+ días para cerrar el mes,
  // escalamos el cap proporcionalmente al # de días que faltan.
  const capBase = last7 > 0 && last14 > 0 ? Math.min(last7, last14 / 2) : (last7 || last14);
