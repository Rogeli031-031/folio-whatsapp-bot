...
const CAPABILITIES = [
  {
    ...
    limitations: "Top N; notas de revisión excluidas del context; sin CRUD desde el chat.",
  },
  {
    id: "dicf",
    label: "DICF",
  ...
  },
  {
    ...
    canRead: true,
    canWrite: false,
    description: "Compromiso / KPIs IGF bajo demanda en el chat.",
    limitations: "No aparece en GET context sources; depende del wording.",
  },
  {
    id: "commercial_state",
  ...
  },
  {
    ...
    canRead: false,
    canWrite: false,
    description: "Entidad folio (estatus, importe, flujo operativo).",
    limitations: "No integrado. Solo comentarios de folio están disponibles como dominio aparte.",
  ...
  },
  {
    ...
    canRead: false,
    canWrite: false,
    description: "Etapa visual / estatus del tablero de folios.",
    limitations: "No integrado. No se puede confirmar la etapa de un folio.",
    relatedReadable: ["folio_comentarios"],
  },
  {
    id: "folio_historial",
    ...
    canRead: false,
    canWrite: false,
    description: "Timeline / últimos movimientos operativos del folio.",
    limitations: "No integrado. No se puede confirmar el último movimiento.",
    relatedReadable: ["folio_comentarios"],
  },
  {
    id: "documentos",
    ...
    canRead: false,
    canWrite: false,
    description: "Cotización, facturas, PDFs y adjuntos del folio.",
    limitations: "No integrado. No se listan documentos faltantes ni URLs.",
    relatedReadable: ["folio_comentarios"],
  },
  {
    id: "cheques",
  ...
  },
  {
    ...
    canRead: false,
    canWrite: false,
    description: "Presupuesto semanal / carro de compra.",
    limitations: "No integrado.",
  ...
  },
  {
    ...
    canRead: false,
    canWrite: false,
    description: "Proyectos por planta y su avance.",
    limitations: "No integrado.",
  ...
  },
  {
    ...
    canRead: false,
    canWrite: false,
    description: "Matrices y comparación Excel de clasificación de apoyos.",
    limitations: "No integrado.",
    relatedReadable: [],
  },
  {
    ...
    canRead: false,
    canWrite: false,
    description: "Gasto de taller agrupado por unidad AT.",
    limitations: "No integrado. Distinto del tema Taller en Action Register / Mejora Continua.",
    relatedReadable: ["action_register", "mejora_continua"],
  },
  {
    id: "gastos",
    ...
    canRead: false,
    canWrite: false,
    description: "Listado o Excel de folios categoría GASTOS.",
    limitations:
      "No integrado. Preguntas de KPI financiero de planta (margen/gasto IGF) siguen rutas existentes distintas.",
  ...
  },
  {
    ...
    canRead: false,
    canWrite: false,
    description: "Listado o Excel de folios categoría INVERSIONES.",
    limitations: "No integrado.",
    relatedReadable: [],
  },
  {
    ...
    canRead: false,
    canWrite: false,
    description: "Modal/endpoints Delta Venta del dashboard.",
    limitations: "No integrado. ARR/IGF on-demand pueden aproximar otras preguntas.",
    relatedReadable: ["arr", "igf", "commercial_state"],
  },
  {
    id: "delta_descuento",
    ...
    canRead: false,
    canWrite: false,
    description: "Modal/endpoints Delta Descuento del dashboard.",
    limitations: "No integrado.",
    relatedReadable: ["arr", "igf"],
  },
  {
    id: "delta_ingreso",
    label: "Delta Ingreso",
    ...
    canRead: false,
    canWrite: false,
    description: "Modal/endpoints Delta Ingreso del dashboard.",
    limitations: "No integrado a esos endpoints; estado comercial/IGF-ARR pueden cubrir preguntas afines.",
    relatedReadable: ["commercial_state", "arr", "igf", "dicf"],
  },
  {
    id: "duplicados",
    ...
    canRead: false,
    canWrite: false,
    description: "Análisis de folios duplicados.",
    limitations: "No integrado.",
    relatedReadable: [],
  },
  {
...
const UNSUPPORTED_RULES = [
  ...
  },
  {
    id: "documentos",
    test: (q) =>
      /\bdocumentos?\b/.test(q) &&
      (/\bfalt/.test(q) || /\badjunt/.test(q) || /\bmedia\b/.test(q) || /\bcotizacion\b/.test(q) || /\bfacturas?\b/.test(q)),
  },
  {
    id: "polizas",
