 ...
 * @returns {{ pairs: Array, scanned: number, groups_importe: number }}
 */
function findDuplicatePairs(rows, opts = {}) {
  ...
  return { pairs, scanned: rows.length, groups_importe: byImporte.size, truncated: false };
}
