...
async function generarDashboardArrForecast(client, year, month, plantCode = null, options = {}) {
  ...
  const includeIgfDiarioPuebla = Boolean(exportPlant) && plantsEquivalent(exportPlant, "Puebla");
  if (includeIgfDiarioPuebla) igfDiarioPuebla.reserveSheet(wb);
