...
const { isPredictiveCommercialQuestion } = require("./director-ia-predictive-commercial");
...
function detectDirectorIaIntent(question) {
  ...
  if (typeof isPredictiveCommercialQuestion === "function" && isPredictiveCommercialQuestion(question)) {
