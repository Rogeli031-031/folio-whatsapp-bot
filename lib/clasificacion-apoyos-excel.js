...
function folioFlagsDetalle(item) {
  ...
  const prestamoSig = !!(item && (item.prestamo_siguiente_mes === true || item.prestamo_siguiente_mes === "t" || item.prestamo_siguiente_mes === 1 || item.prestamo_siguiente_mes === "1"));
