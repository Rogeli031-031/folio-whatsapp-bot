...
const cases = [
  ...
  () => expectIntent("¿Qué proyectos están retrasados?", "project_status"),
  ...
  () => expectIntent("¿Cómo cambió la venta?", "delta_sales"),
  () => expectIntent("¿Cómo cambió el descuento?", "delta_discount"),
  () => expectIntent("¿Cómo cambió el ingreso?", ["delta_income", "financial_diagnosis"]),
