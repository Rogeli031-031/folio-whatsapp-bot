...
R-VENTA = PROVEN
R-HM-PROFILE = PROVEN
R-METRIC-SWITCH = PROVEN

FIRST_BAD_COMMIT = 93404936
FOR_ALL_4_REGRESSIONS = YES

FIRST_TURN_EXECUTIVE_STATUS = PROTECTED
FRESH_SESSION_EXECUTIVE_STATUS = PASS

HISTORICAL_MARGIN_GLOBAL_BREAKAGE = NO
STATE_DEPENDENT_ROUTING_FAILURE = PROVEN
EXPLICIT_METRIC_SWITCH_FAILURE = PROVEN

HTTP500_SALES_DISCOUNT =
SECOND_BUG_IN_HISTORICAL_MARGIN_COMPARE_STATUS_MAPPING

META_CODES_MAP =
PREEXISTING_BUG
NOT_CAUSED_BY_HISTORICAL_MARGIN

G9_G10 =
CONTEXT_REQUIRED / EXPECTED_BEHAVIOR

MAY_FINAL_REASON = NOT_PROVEN
AUGUST_FINAL_REASON = NOT_PROVEN
LIVE_DB = NOT_PROVEN

CURRENT_SUITE = 1440_PASS_0_FAIL
BASELINE_SUITE = 1411_PASS_0_FAIL
SUITE_GREEN_BUT_REGRESSION_NOT_COVERED = YES

AUDIT_READY_TO_CLOSE_AND_MERGE = YES
AUDIT_CLOSED_BY_HUMAN = YES
...
Esta aprobación humana autoriza únicamente cerrar e integrar
la documentación de
AUDIT-DIRECTOR-IA-HISTORICAL-MARGIN-REGRESSION-RECOVERY-001.

No autoriza implementar las cuatro regresiones.
No autoriza rollback.
No autoriza deploy.
